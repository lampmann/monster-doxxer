...
(function (root, factory) {
  ...
  /* ============================================================
     ...
     group heading is that.
     ============================================================ */
  const GROUPS = [
    {
      id: "magic", label: "It shrugged off our magic",
      traits: [
        ...
        { n: "psychic defense", d: "added its own force of personality to its armour class while unarmoured" },
        ...
        { n: "alien mind", d: "reading its mind hurt the reader", k: "psychic backlash" },
        { n: "axiomatic mind", d: "could not be compelled to act against its nature, or have its thoughts read" },
    ...
    {
      id: "die", label: "It would not stay down",
      traits: [
        ...
        { n: "darklord restoration", d: "cannot be permanently killed inside its own domain — it returns" },
    ...
    {
      id: "hit", label: "We could not land a hit",
      traits: [
        ...
        { n: "elemental demise", d: "left no body at all when it died", k: "vanished corpse dissolved" },
      ],
    },
    {
      id: "weak", label: "Something in the room hurt it",
      traits: [
    ...
    {
      id: "move", label: "How it got around",
      traits: [
    ...
    {
      id: "sense", label: "It noticed things it should not have",
      traits: [
        ...
        { n: "creature sense", d: "knew what kinds of creatures were near it, and roughly where" },
        { n: "otherworldly perception", d: "sensed the presence and mood of everything nearby without looking" },
        { n: "labyrinthine recall", d: "remembered perfectly every route it had ever walked", k: "minotaur maze never lost" },
        { n: "wakeful", d: "was never fully asleep — one part of it stayed alert" },
        { n: "ambusher", d: "advantage against anything it had surprised" },
      ],
    },
    {
      id: "talk", label: "How it communicated",
      traits: [
        ...
        { n: "primal bond", d: "was bonded to a beast or a place and drew on it" },
      ],
    },
    {
      id: "fight", label: "How it fought",
      traits: [
        ...
        { n: "empowered attacks", d: "an outside source made its attacks hit harder than the statblock suggests" },
        { n: "marshal undead", d: "made the undead around it fight better" },
        ...
        { n: "combat ready", d: "went first, or close to it, every fight", k: "initiative fast" },
      ],
    },
    {
      id: "near", label: "Just being near it hurt",
      traits: [
        ...
        { n: "insanity", d: "could not be reasoned with, and was immune to being frightened or charmed for it" },
      ],
    },
    {
      id: "hide", label: "Before we knew what it was",
      traits: [
        ...
        { n: "animated", d: "was an object we had taken for furniture until it moved" },
    ...
    },
    {
      ...
      traits: [
        ...
        { n: "disintegration", d: "something it destroyed was reduced to dust, not merely killed" },
        { n: "spell storing", d: "held a spell put into it by someone else and cast it later" },
        { n: "the colors of age", d: "its colour told you how old and how dangerous it was" },
        { n: "ashen creature", d: "was made of, or bound to, ash and cinders" },
        { n: "bound", d: "was tied to a place or an object and could not leave it" },
        { n: "water bound", d: "could not leave the water it lived in" },
